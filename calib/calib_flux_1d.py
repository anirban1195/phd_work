...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb  6 09:33:31 2023
...
#bkgArr= [ 50, 100, 200]
fluxArr = np.hstack((np.arange(0, 10, 1), np.arange(10, 100, 10), np.arange(100, 1000, 100), 
...
#plt.legend()
np.save('/scratch/bell/dutta26/abell_2390/calib_' +str(id_num)+'.npy', store)    
