...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan 23 09:01:44 2023
...
store = np.ones((totRows, 6))
store = store*np.nan

count = 0
for sqrtba in sqrtbaArr:
   
    bkg = (sqrtba/ (sigx*sigy*3.14))**2
    print (bkg, sigx, sigy)
    biasArr=[]
    biasArr2=[]
    for flux in fluxArr:
        ...
        store [count, 4], store [count, 5] = bkg, sigx
...
#plt.legend()
np.save('/scratch/bell/dutta26/abell_2390/calib_44_test.npy', store)    
