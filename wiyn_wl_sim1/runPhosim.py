...
for j in range(noImages):
    ...
    #For normal images
    outLoc = '/scratch/bell/dutta26/wiyn_sim1/'+filt+'/'+str(idNo)+"/"
    helper_phosim.check_n_remove_existing(outLoc)
    phosim_command = './phosim '+catalog+' -i wiyn_odi -c examples/quickbackground -o '+outLoc+' -w /scratch/bell/dutta26/wiyn_sim1/work1/ -s "OTA32|OTA33|OTA34|OTA35|OTA43|OTA44|OTA45|OTA53|OTA54|OTA55|OTA23" '
    ...
    #For star images
    outLoc_star = '/scratch/bell/dutta26/wiyn_sim1/'+filt+'/'+str(idNo)+"_star/"
    helper_phosim.check_n_remove_existing(outLoc_star)
    phosim_command = './phosim '+catalog_star+' -i wiyn_odi -c examples/quickbackground -o '+outLoc_star+' -w /scratch/bell/dutta26/wiyn_sim1/work1/'
