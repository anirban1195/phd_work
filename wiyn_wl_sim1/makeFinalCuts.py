...
file ='/scratch/bell/dutta26/wiyn_sim1/median_coadds/ir_coadd_med.weight.fits'
new_file = '/scratch/bell/dutta26/wiyn_sim1/median_coadds/ir_coadd_med_crop.weight.fits'
#file = str(sys.argv[1])
