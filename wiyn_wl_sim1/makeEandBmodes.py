...
# =============================================================================
    ...
    plt.savefig('/scratch/bell/dutta26/wiyn_sim1/sig_dev.png')
    plt.close()
...
#     save_arr[:,1] = arr_sf_wt1
#     plt.plot(arr_sf_wt, arr_sf_wt1, 'r.')
#     plt.savefig('/scratch/bell/dutta26/wiyn_sim/wt_comp.png')
#     plt.close()
#     np.save('/scratch/bell/dutta26/wiyn_sim/wt_comp.npy', save_arr)
# =============================================================================
...
#             if(len(epar[goodEllipIndices[0]])>0):
#                 e1sum = e1sum/len(epar[goodEllipIndices[0]])
#                 e2sum = e2sum/len(epar[goodEllipIndices[0]])
#             else:
#                 e1sum, e2sum = 0,0
...
#     hdu.writeto('/scratch/bell/dutta26/wiyn_sim/EMode_sf1.fits', overwrite=True)
#     
#     hdu = fits.PrimaryHDU(imgB,header=header)  
#     hdu.writeto('/scratch/bell/dutta26/wiyn_sim/BMode_sf.fits', overwrite=True)
#     
#     hdu = fits.PrimaryHDU(count_img, header=header)  
#     hdu.writeto('/scratch/bell/dutta26/wiyn_sim/count_img_sf.fits', overwrite=True)
#                 
#     
#                 
#     
