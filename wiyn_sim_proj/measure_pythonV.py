...
def measure_v3(img, guessAlphax =3, guessAlphay =3, guessAlphaxy =0 , counter_target = 100, mux_calc = 0, muy_calc= 0):
    #Shape the image properly
    img = np.array(img)
    sizey, sizex = np.shape(img)
...
def measure_bkgFix(img, guessAlphax =3, guessAlphay =3, guessAlphaxy =0 , counter_target = 100, bkg=-2):
    #Shape the image properly
    img = np.array(img)
    sizey, sizex = np.shape(img)
