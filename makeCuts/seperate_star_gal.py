...
plt.plot(sizeArr[loc], fluxArr[loc],'b.', markersize= 2)  
loc = np.array(df_source.index[df_source['star_bool'] == 1].tolist())
plt.plot(sizeArr[loc], fluxArr[loc],'r.', markersize= 2)  
plt.xlabel('Size')
plt.ylabel('Flux')
plt.plot([psfMax, psfMin], [1e5, 1e5], 'k-',markersize= 2)
plt.plot([psfMax, psfMin], [fluxMin, fluxMin], 'k-',markersize= 2)
plt.plot([psfMax, psfMax], [1e5, fluxMin], 'k-',markersize= 2)
plt.plot([psfMin, psfMin], [1e5, fluxMin], 'k-',markersize= 2)
...
plt.plot(psfMin-3*size_err, flux_arange, 'y-')
plt.plot([0,15], [1e4, 1e4], 'y-')
plt.plot([15,15], [0.2, 1e4], 'y-')
