...
# =============================================================================
    ...
    outFile = '/scratch/bell/dutta26/abell_2390/' +str(band)+'_sf.npy'
...
band_coadd_df_name = '/scratch/bell/dutta26/abell_2390/abell_'+ str(band)+'_coadd.npy'
ir_coadd_df_name = '/scratch/bell/dutta26/abell_2390/abell_ir_coadd.npy'
outLoc= '/scratch/bell/dutta26/abell_2390/abell_'+band+'_coadd.npy'
