...
# -*- coding: utf-8 -*-
"""
Created on Sat Nov 20 09:07:53 2021
...
#     swarpCommand = './swarp @/home/dutta26/temp.ascii -c /home/dutta26/default_1.swarp -IMAGEOUT_NAME /scratch/halstead/d/dutta26/abell_2390/'+band+'/temp/temp_coadd_'+str(fileCount)+'.fits'
# 
...
# =============================================================================
    ...
    f=fits.open('/scratch/halstead/d/dutta26/abell_2390/'+band+'/temp/temp_coadd_'+str(fileCount)+'.fits')
    ...
    xList, yList = helper.convertToXY(raList, decList, '/scratch/halstead/d/dutta26/abell_2390/'+band+'/temp/temp_coadd_'+str(fileCount)+'.fits')
    ...
    for j in range(len(xList)):
        ...
        noise = np.sqrt( back_h * 3.14* (3*seeing)**2) *flux_scale
    ...
    for j in range(len(xList)):
        ...
        store[fileCount,j,41:48] = t1, t2, t3,  t4, t5, t6, t7
...
np.save('/scratch/halstead/d/dutta26/abell_2390/test4t3_' +str(band)+'.npy', store)
