...
# =============================================================================
            ...
            if(len(epar[goodEllipIndices])>0):
                e1sum = e1sum*fudge_fact*wt_corr/(2*3.14*n_bar)
    ...
    hdu.writeto('/scratch/bell/dutta26/abell_2390/kappa_sf.fits', overwrite=True)
    ...
    hdu.writeto('/scratch/bell/dutta26/abell_2390/kappa_error_sf.fits', overwrite=True)
