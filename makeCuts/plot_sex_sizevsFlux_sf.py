...
# -*- coding: utf-8 -*-
"""
Created on Fri Mar 10 10:20:12 2023
...
plt.plot(x_values, gaussian(x_values,10.7+xShift, errSize1, np.max(n)), 'r-',linewidth = 2)
plt.plot(x_values, gaussian(x_values,10.7+xShift, errSize3, np.max(n)), 'g-',linewidth = 2)
