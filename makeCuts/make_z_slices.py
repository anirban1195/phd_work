...
# -*- coding: utf-8 -*-
"""
Created on Tue Jan 23 11:52:42 2024
...
def EandB(ir_coadd_data_name, r_coadd_npy_name, i_coadd_npy_name, zFile, outFile, coadd_img, r_sf_name, i_sf_name, z_min, z_max, seq_no):
...
#             cond = np.where((master_frame[:,0] > x_mid-4000) & (master_frame[:,0] < x_mid+4000) & 
#                             (master_frame[:,1] > y_mid-4000) & (master_frame[:,1] < y_mid+4000) 
...
# =============================================================================
    ...
    hdu.writeto('/scratch/bell/dutta26/abell_2390/zSlice/EMode_sf'+str(seq_no)+'.fits', overwrite=True)
    hdu = fits.PrimaryHDU(err_img,header=header)  
    hdu.writeto('/scratch/bell/dutta26/abell_2390/zSlice/BMode_sf'+str(seq_no)+'.fits', overwrite=True)
    print (z_max, z_min)
...
for j in range(len(zminArr)):
    ...
    EandB( '/scratch/bell/dutta26/abell_2390/abell_ir_coadd.npy',  '/scratch/bell/dutta26/abell_2390/abell_r_coadd.npy', '/scratch/bell/dutta26/abell_2390/abell_i_coadd.npy', zFile, ebModeFile, img, '/scratch/bell/dutta26/abell_2390/r_sf.npy', '/scratch/bell/dutta26/abell_2390/i_sf.npy', zmin,zmax, count)
    count += 1
