...
# =============================================================================
#         if((1- (alphaxy/(alphax*alphay))**2 ) < 0):
#             counter = 100
#             break
#         A =1/(2*np.pi*alphax*alphay*np.sqrt(1- (alphaxy/(alphax*alphay))**2 ))
#         k=(A * np.exp(-((x-mux_calc)**2/(2*alphax**2)+ (y-muy_calc)**2/(2*alphay**2) - 2*alphaxy*(y-muy_calc)*(x-mux_calc)/(alphax**2 * alphay**2 ) )))
# =============================================================================
        while( (alphaxy/(alphax*alphay))**2  >= 1):
            ...
            if (abs(alphaxy) > 100):
                counter =100
                break
        if(abs(alphax)> 100 or abs(alphay)> 100):
            counter = 100
            break
