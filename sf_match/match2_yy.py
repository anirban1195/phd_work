...
# -*- coding: utf-8 -*-
"""
Created on Tue Aug 29 15:42:47 2023
...
#for slice_no in [32]:
    ...
    yVal =[]
    tot = 0
    start = mean_yy - 10*np.sqrt(k_guess_yy**2 + err_yy**2)
    cutoff = mean_yy + 10*np.sqrt(k_guess_yy**2 + err_yy**2)
    #center = 13.6
    ...
    #print (parameters)
    kArr.append(np.sqrt(parameters[1]**2 - err_yy**2))
